  ...
  return (
    <div className="mx-auto max-w-5xl px-6 py-20">
      <header className="text-center text-slate-100">
        <h1 className="text-display md:text-6xl font-serif bg-slate-200 border-yellow-300 border shadow-sm text-7xl font-thin text-white opacity-0">MyBlessings, How you BLESS..</h1>
