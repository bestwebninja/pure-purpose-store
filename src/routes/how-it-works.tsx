  ...
  return (
    <div className="mx-auto max-w-5xl px-6 py-20">
      <header className="text-center">
        ...
        <p className="mx-auto mt-4 max-w-2xl text-lg text-muted-foreground text-blue-800">
        ...
        {STEPS.map((s, i) => (
          <div key={s.title} className="rounded-2xl border border-border/60 bg-card p-6 shadow-soft">
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm font-medium text-muted-foreground text-blue-800">Step {i + 1}</span>
            </div>
            <h3 className="text-display mt-4 text-xl font-semibold">{s.title}</h3>
            <p className="mt-2 text-sm text-muted-foreground text-blue-800">{s.body}</p>
          </div>
        ))}
      </div>
      <div className="mt-16 rounded-3xl bg-gradient-warm p-10 text-center">
        ...
        <p className="mx-auto mt-2 max-w-2xl text-muted-foreground text-blue-800">
