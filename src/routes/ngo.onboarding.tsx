    ...
    <div className="mx-auto max-w-3xl px-6 py-12">
      <header className="mb-12">
        ...
        <nav className="mt-6 flex flex-wrap gap-2">
          ...
          <Button variant="ghost" size="sm" className="text-white" onClick={() => scrollTo("section-mission")}>2. Mission</Button>
          <Button variant="ghost" size="sm" className="text-white" onClick={() => scrollTo("section-impact")}>3. Impact</Button>
        </nav>
      </header>
