...
import type { LifecycleCounts } from "@/server/api/gateway";
const STAGES: Array<{
...
export function BlessingLifecycle({
  ...
  return <Card className="p-4 sm:p-6">
      <div className="mb-4 flex items-center justify-between">
        <h2 className="text-sm font-semibold uppercase tracking-wide text-muted-foreground text-slate-50">Blessing Lifecycle</h2>
